...
public class MobileAPI {
    ...
    public void setUp(@Optional("android")String OS,@Optional("mobile") String appType,@Optional("Real Device") String deviceType,
        ...
        if(OS.equalsIgnoreCase("ios")){
            if(appType.contains("iPhone")){
                ...
                findApp = new File(appDirectory,"/Users/kamranzaib/Desktop/IT CLASS /MobileAutomation-master1/UiCatalog/src/app/UICatalog.app");
            ...
            if(appType.contains("Phone")){
                appDirectory = new File("/Users/kamranzaib/Desktop/IT CLASS /MobileAutomation-master1/NYP/src/app");
    ...
    public AppiumDriver setUpAndroidEnv(String deviceName,String version)throws IOException,InterruptedException{
        ...
        cap.setCapability(MobileCapabilityType.PLATFORM_VERSION, version);
        cap.setCapability("avd", "AVD_for_Nexus6");
        cap.setCapability("appPackage", "br.com.golmobile.nypost");
        cap.setCapability("appActivity", "br.com.golmobile.nypost.app.StartupActivity");
        cap.setCapability(MobileCapabilityType.APP, findApp.getAbsolutePath());
